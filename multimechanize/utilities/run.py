...
def run_test(project_name, cmd_opts, remote_starter=None):
    ...
    run_time, rampup, results_ts_interval, console_logging, progress_bar, results_database, post_run_script, xml_report, user_group_configs, generator_scripts = configure(project_name, cmd_opts)
